...
C.themes["Blizzard_AchievementUI"] = function()
	...
	F.HideBackdrop(AchievementFrameCategories) -- isNewPatch
	...
	AchievementFrameSummaryCategoriesStatusBar:SetStatusBarTexture(C.bdTex)
	...
	for i = 1, 12 do
		...
		F.StripTextures(bu)
		bu:SetStatusBarTexture(C.bdTex)
